package com.dore.doresegmentlitedemo
...
import com.dore.segmentlite.SegmentLiteManager
import kotlinx.android.synthetic.main.image_segment_view.*
import java.io.IOException
import android.graphics.drawable.BitmapDrawable
import android.util.Log
import com.dore.segmentlite.SegmentLiteListener


class ImageSegmentView : AppCompatActivity() {

    private val bEngine: SegmentLiteManager = SegmentLiteManager()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bEngine.setSegmentLiteListener(object : SegmentLiteListener {
